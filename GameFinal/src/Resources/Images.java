...
// Para logica de respirar derecha/izquierda, hcaer un booleano para tener registrado el ultimo ingreso por teclado, para saber para que lado debe respirar
			...
			blocks[0]= ImageIO.read(getClass().getResourceAsStream("/Blocks/pared.jpg"));
			blocks[1]= ImageIO.read(getClass().getResourceAsStream("/Blocks/spike1.png"));
			blocks[2]= ImageIO.read(getClass().getResourceAsStream("/Blocks/tierra.jpg"));
			blocks[3]= ImageIO.read(getClass().getResourceAsStream("/Blocks/cas1.png"));
			blocks[4]= ImageIO.read(getClass().getResourceAsStream("/Blocks/cas2.png"));
			blocks[5]= ImageIO.read(getClass().getResourceAsStream("/Blocks/cas3.png"));
			blocks[6]= ImageIO.read(getClass().getResourceAsStream("/Blocks/cas4.png"));
			blocks[7]= ImageIO.read(getClass().getResourceAsStream("/Blocks/piso.png"));
			blocks[8]= ImageIO.read(getClass().getResourceAsStream("/Blocks/tree.png"));
			blocks[9]= ImageIO.read(getClass().getResourceAsStream("/Blocks/tree2.png"));
			blocks[10]= ImageIO.read(getClass().getResourceAsStream("/Blocks/goomba.gif"));
		} catch (IOException e) {
